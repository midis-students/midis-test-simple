...
const q: Question = {
  ...
  query() {
    ...
    <p>Напишите функцию <strong>odd_array(array)</strong> дан массив, состоящий из целых чисел. Напишите программу, которая возвращает те элементы массива, которые являются чётными числами.
    <br>Пример<br>
    <br>Ввод
